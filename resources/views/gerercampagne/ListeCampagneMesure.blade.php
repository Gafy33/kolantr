...
<div class="containerForm-Validation" >
  <main>
    <div class="py-5 text-center">
      <h2 class="mx-auto mb-1 py-5 featurette-heading"><span class="text-muted" ><i class="fas fa-route" width="75" height="75" fill="currentColor" ></i>  Gérer Campagne Mesure <i class="fas fa-route" width="75" height="75" fill="currentColor" ></i> </span></h2>
    ...
    <div class="row g-3   shadow p-3">
      <div class="col-md-7 col-lg-12 mx-auto ">
        ...
        <div class="col-md-3">
              <label for="firstName" class="form-label @if(Auth::user()->preference == "theme_dark") tx-white @else tx-black @endif">{!! $campagne->adresseCampagne !!}</label>
        </div>

        <div class="col-md-2">
              <label for="firstName" class="form-label @if(Auth::user()->preference == "theme_dark") tx-white @else tx-black @endif">{!! $campagne->ville !!}</label>
        </div>

        <div class="col-md-1">
              <label for="firstName" class="form-label @if(Auth::user()->preference == "theme_dark") tx-white @else tx-black @endif">{!! $campagne->numeroRoute !!}</label>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarsExample{!! $campagne->id !!}">
        <div class="col-md-6">
              <label for="firstName" class="form-label @if(Auth::user()->preference == "theme_dark") tx-white @else tx-black @endif">{!! $campagne->DébutCampagne !!}</label>
        </div>
        <div class="col-md-4">
              <label for="firstName" class="form-label @if(Auth::user()->preference == "theme_dark") tx-white @else tx-black @endif">{!! $campagne->statut !!}</label>  
        </div>
        <div class="col-md-1">
                <a href="{{ route('modifierCampagneMesure_path', ['id' => $campagne->id ])}}"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
        ...
        <div class="col-md-1">
                <a onclick="return confirmdelete();" href="{{ route('deleteCampagneMesure_path', ['id' => $campagne->id ])}}"> <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
