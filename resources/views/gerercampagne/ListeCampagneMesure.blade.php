...
<div class="containerForm-Validation">
  <main>
    <div class="py-5 text-center">
      <h2 class="mx-auto mb-1 py-5 featurette-heading"><span class="text-muted"> <i class="fas fa-user"  width="75" height="75" fill="currentColor" ></i>  Gérer Campagne Mesure  <i class="fas fa-user"  width="75" height="75" fill="currentColor"></i> </span></h2>
    ...
    <div class="row g-3   shadow p-3">
      <div class="col-md-7 col-lg-12 mx-auto ">
        ...
        <div class="col-md-6">
              <label for="firstName" class="form-label @if(Auth::user()->preference == "theme_dark") tx-white @else tx-black @endif">{!! $campagne->DebutCampagne !!}</label>
        </div>
        <div class="col-md-4">
