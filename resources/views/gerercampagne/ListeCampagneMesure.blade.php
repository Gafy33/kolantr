  ...
  <main>
    ...
    <div class="row g-3   shadow p-3">
      <div class="col-md-7 col-lg-12 mx-auto ">
        ...
        <div class="col-md-3">
              <label for="firstName" class="form-label tx-black ">{!! $campagne->adresseCampagne !!}</label>
        </div>

        <div class="col-md-2">
              <label for="firstName" class="form-label tx-black">{!! $campagne->ville !!}</label>
        </div>
        ...
        <div class="col-md-6">
              <label for="firstName" class="form-label tx-black">{!! $campagne->DébutCampagne !!}</label>
        </div>
        <div class="col-md-4">
              <label for="firstName" class="form-label tx-black">{!! $campagne->statut !!}</label>  
        </div>
        <div class="col-md-1">
