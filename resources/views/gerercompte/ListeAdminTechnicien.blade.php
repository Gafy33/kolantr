@extends('layouts.home', ['title' => 'Gérer Compte Admin / Technicien'])
  ...
  <main>
    ...
    <div class="row g-3   shadow p-3">
      <div class="col-md-7 col-lg-12 mx-auto ">
        <div class="row g-3">
            <div class="col-md-8">
                 <a href="{{ route('inscriptionCompteAdmin')}}"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="35" fill="currentColor" class="bi bi-person-plus" viewBox="0 0 16 16">
    ...
    <div class="row g-3   shadow p-3">
      <div class="col-md-7 col-lg-12 mx-auto ">
        ...
        @if($client->role->name == "admin" or $client->role->name == "technicien")
        <div class="navbar navbar-expand-lg navbar-dark" aria-label="Eighth navbar example">
        <div class="container">
        ...
        <div class="col-md-1">
               <a href="{{ route('modifierAdminTechnicien_path', ['id' => $client->id ])}}"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
        ...
        <div class="col-md-1">
                <a onclick="return confirmdelete();" href="{{ route('deleteAdminTechnicien_path', ['id' => $client->id ])}}"> <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
