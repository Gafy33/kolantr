        ...
        <form class="needs-validation" novalidate method="POST" action="{{ route('ajouterAdminTechnicien_path')}}">
          ...
          <div class="my-3">
            <div class="form-check">
              <input name="role" type="radio" class="form-check-input" value="1" required checked> <span class="tx-black"> Admin </span>
            </div>
            <div class="form-check">
              <input name="role" type="radio" class="form-check-input" value="3" required> <span class="tx-black"> Technicien </span>
            </div>
          </div>
