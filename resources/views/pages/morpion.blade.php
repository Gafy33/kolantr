      ...
      if (!estValide(this)) {
        ...
        if (jeuEstFini) {
          afficheur.sendMessage(
            "Le joueur " +
              joueurs[tour] +
              ' a gagné ! <br /> <a href="accueil">Rejouer</a>'
          );
          var div2 = document.getElementById("morpion_div");
          var div3 = document.getElementById("puissance_div");
        ...
        if (matchNul(pions)) {
          afficheur.sendMessage(
            'Match Nul ! <br/> <a href="accueil">Rejouer</a>'
          );
          return;
        }
